...
export default class ZegoExpressEngine {
  ...
  setStreamAlignmentProperty(alignment, channel) {
    return ZegoExpressEngineImpl.getInstance().setStreamAlignmentProperty(alignment, channel)
  }
  /**
  ...
  setAudioCaptureStereoMode(mode) {
    return ZegoExpressEngineImpl.getInstance().setAudioCaptureStereoMode(mode)
  }
  /**
  ...
  enableVideoObjectSegmentation(enable, config, channel) {
    return ZegoExpressEngineImpl.getInstance().enableVideoObjectSegmentation(
      enable,
      config,
      channel
    )
  ...
  enableAlphaChannelVideoEncoder(enable, alphaLayout, channel) {
    return ZegoExpressEngineImpl.getInstance().enableAlphaChannelVideoEncoder(
      enable,
      alphaLayout,
      channel
    )
  ...
  setPlayStreamBufferIntervalRange(streamID, minBufferInterval, maxBufferInterval) {
    return ZegoExpressEngineImpl.getInstance().setPlayStreamBufferIntervalRange(
      streamID,
      minBufferInterval,
      maxBufferInterval
    )
  ...
  setPlayStreamsAlignmentProperty(mode) {
    return ZegoExpressEngineImpl.getInstance().setPlayStreamsAlignmentProperty(mode)
  }
  /**
  ...
  setAudioDeviceMode(deviceMode) {
    return ZegoExpressEngineImpl.getInstance().setAudioDeviceMode(deviceMode)
  }
  /**
  ...
  enableVirtualStereo(enable, angle) {
    return ZegoExpressEngineImpl.getInstance().enableVirtualStereo(enable, angle)
  }
  /**
  ...
  createRealTimeSequentialDataManager(roomID) {
    return ZegoExpressEngineImpl.getInstance().createRealTimeSequentialDataManager(roomID)
  }
  /**
  ...
  destroyRealTimeSequentialDataManager(manager) {
    return ZegoExpressEngineImpl.getInstance().destroyRealTimeSequentialDataManager(manager)
  }
  /**
  ...
  enableCustomAudioCaptureProcessing(enable, config) {
    return ZegoExpressEngineImpl.getInstance().enableCustomAudioCaptureProcessing(enable, config)
  }
  /**
  ...
  enableCustomAudioCaptureProcessingAfterHeadphoneMonitor(enable, config) {
    return ZegoExpressEngineImpl.getInstance().enableCustomAudioCaptureProcessingAfterHeadphoneMonitor(
      enable,
      config
    )
  }
  ...
  enableAlignedAudioAuxData(enable, param) {
    return ZegoExpressEngineImpl.getInstance().enableAlignedAudioAuxData(enable, param)
  }
  /**
  ...
  enableBeforeAudioPrepAudioData(enable, param) {
    return ZegoExpressEngineImpl.getInstance().enableBeforeAudioPrepAudioData(enable, param)
  }
  /**
  ...
  enableCustomAudioRemoteProcessing(enable, config) {
    return ZegoExpressEngineImpl.getInstance().enableCustomAudioRemoteProcessing(enable, config)
  }
  /**
  ...
  enableCustomAudioPlaybackProcessing(enable, config) {
    return ZegoExpressEngineImpl.getInstance().enableCustomAudioPlaybackProcessing(enable, config)
  }
  /**
  ...
  createCopyrightedMusic() {
    return ZegoExpressEngineImpl.getInstance().createCopyrightedMusic()
  }
  /**
  ...
  destroyCopyrightedMusic(copyrightedMusic) {
    return ZegoExpressEngineImpl.getInstance().destroyCopyrightedMusic(copyrightedMusic)
  }
  /**
