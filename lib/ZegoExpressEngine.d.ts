...
export default class ZegoExpressEngine {
  ...
  off<EventType extends keyof ZegoEventListener>(
    event: EventType,
    callback: undefined | ZegoEventListener[EventType]
  ): void
  /**
  ...
  loginRoom(
    roomID: string,
    user: zego.ZegoUser,
    config: undefined | zego.ZegoRoomConfig
  ...
  startPublishingStream(
    streamID: string,
    channel: undefined | zego.ZegoPublishChannel,
    config: undefined | zego.ZegoPublisherConfig
  ): Promise<void>
  /**
  ...
  enablePublishDirectToCDN(
    enable: boolean,
    config: undefined | zego.ZegoCDNConfig,
    channel: undefined | zego.ZegoPublishChannel
  ): Promise<void>
  /**
  ...
  startPlayingStream(
    streamID: string,
    view: undefined | zego.ZegoView,
    config: undefined | zego.ZegoPlayerConfig
  ): Promise<void>
  /**
  ...
  startNetworkSpeedTest(
    config: zego.ZegoNetworkSpeedTestConfig,
  ...
  enableCustomVideoCapture(
    enable: boolean,
    config: undefined | zego.ZegoCustomVideoCaptureConfig,
    channel: undefined | zego.ZegoPublishChannel
  ): Promise<void>
  /**
  ...
  enableCustomVideoProcessing(
    enable: boolean,
    config: undefined | zego.ZegoCustomVideoProcessConfig,
    channel: undefined | zego.ZegoPublishChannel
  ): Promise<void>
  /**
